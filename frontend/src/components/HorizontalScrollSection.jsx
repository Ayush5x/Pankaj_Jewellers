...
/*
 * Below this width the "scroll-jack" pin animation is skipped.
 * On phones/tablets, pinning the section for as long as it takes
 * the whole card track to scroll by creates a huge amount of
 * empty vertical space (since narrow viewports need much more
 * scroll distance to cover the same track width), and it also
 * fights with the browser's own address-bar resize behaviour.
 * A plain, native, swipeable row is the correct UX there.
 */
